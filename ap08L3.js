...
export function init(scene, size, id, offset, texture) {
    ...
    function makeBuilding(x, z, type) {
        ...
        bldg.position.set(offset.x + x, bldgH/2, offset.z + z); //空欄箇所
        scene.add(bldg);
    }
    makeBuilding(40, 30, 1);
    makeBuilding(6, 35, 4);
    makeBuilding(100, 19, 2);
    makeBuilding(10, 20, 3);
    makeBuilding(-20, 35, 1);
    makeBuilding(68, -20, 1);
    makeBuilding(60, -20, 1);
    makeBuilding(52, -20, 1);
    makeBuilding(44, -20, 1);
    makeBuilding(52, -20, 1);
    makeBuilding(68, -12, 1);
    makeBuilding(44, -12, 1);
    makeBuilding(68, -4, 1);
    makeBuilding(44, -4, 1);
    makeBuilding(68, -4, 1);
    makeBuilding(44, -4, 1);
    ...
    makeBuilding(52, -4, 4);
    makeBuilding(60, -4, 4);
    makeBuilding(52, -12, 4);
    makeBuilding(60, -12, 4);
    // コース(描画)
    // 制御点を補間して曲線を作る
